...
export default class Logger{
    ...
    createMorganLogger(app:any){
       ...
       const basedir=path.join(__dirname,"../../../../../../var/log/application_logs/usermanagementservice");
    ...
    logWihWinston(tolog:any,dir:string){
       const basedir=path.join(__dirname,"../../../../../../var/log/application_logs/usermanagementservice",'/access.log');
